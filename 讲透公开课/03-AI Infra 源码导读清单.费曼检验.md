# 费曼检验（⚠️ 不适用）· 讲透公开课 · 03 - AI Infra 源码导读清单

> 自动生成 2026-08-04 19:49 | 原文 [`讲透公开课/03-AI Infra 源码导读清单.md`](../讲透公开课/03-AI Infra 源码导读清单.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
...
- 原文行数：约 295+ 行
- 抽到的 H1：讲透公开课 · 03 - AI Infra 源码导读清单
- H2 数量：9
- 黑名单术语出现：121 次（无需外行翻译，因为这不是教学）
- 数学公式：0 行内 / 0 块
