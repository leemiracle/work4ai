# 费曼检验（⚠️ 不适用）· 心理学 · ToM（心智理论）测试数学

> 自动生成 2026-08-04 19:49 | 原文 [`讲透AIfor各学科/心理学/advanced/01-ToM测试数学.md`](../讲透AIfor各学科/心理学/advanced/01-ToM测试数学.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
...
- 原文行数：约 181+ 行
- 抽到的 H1：心理学 · ToM（心智理论）测试数学
- H2 数量：8
- 黑名单术语出现：10 次（无需外行翻译，因为这不是教学）
- 数学公式：4 行内 / 2 块
