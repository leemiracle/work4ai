# 费曼检验（⚠️ 不适用）· 语言学 · LLM 句法 circuit 探测

> 自动生成 2026-08-04 19:49 | 原文 [`讲透AIfor各学科/语言学/advanced/01-LLM句法circuit探测.md`](../讲透AIfor各学科/语言学/advanced/01-LLM句法circuit探测.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
...
- 原文行数：约 197+ 行
- 抽到的 H1：语言学 · LLM 句法 circuit 探测
- H2 数量：7
- 黑名单术语出现：4 次（无需外行翻译，因为这不是教学）
- 数学公式：4 行内 / 1 块
