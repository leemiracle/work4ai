# 费曼检验（⚠️ 不适用）· 考古学 · 古 DNA + 数字遗产应用

> 自动生成 2026-08-04 19:49 | 原文 [`讲透AIfor各学科/考古学/advanced/02-古DNA与数字遗产应用.md`](../讲透AIfor各学科/考古学/advanced/02-古DNA与数字遗产应用.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
