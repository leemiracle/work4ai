# 费曼检验（⚠️ 不适用）· 软件工程 · SWE-bench + Agent 数学

> 自动生成 2026-08-04 19:49 | 原文 [`讲透AIfor各学科/软件工程/advanced/01-SWEAgent数学.md`](../讲透AIfor各学科/软件工程/advanced/01-SWEAgent数学.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
...
- 原文行数：约 200+ 行
- 抽到的 H1：软件工程 · SWE-bench + Agent 数学
- H2 数量：7
