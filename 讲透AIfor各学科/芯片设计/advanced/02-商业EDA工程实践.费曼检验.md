# 费曼检验（⚠️ 不适用）· 芯片设计 · Synopsys / Cadence 工程实践

> 自动生成 2026-08-04 19:49 | 原文 [`讲透AIfor各学科/芯片设计/advanced/02-商业EDA工程实践.md`](../讲透AIfor各学科/芯片设计/advanced/02-商业EDA工程实践.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
...
- 原文行数：约 196+ 行
- 抽到的 H1：芯片设计 · Synopsys / Cadence 工程实践
- H2 数量：7
- 黑名单术语出现：9 次（无需外行翻译，因为这不是教学）
- 数学公式：0 行内 / 0 块
