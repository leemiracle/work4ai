# 费曼检验（⚠️ 不适用）· 天文 · LSST 时代的前沿工程

> 自动生成 2026-08-04 19:49 | 原文 [`讲透AIfor各学科/天文/advanced/02-LSST时代前沿工程.md`](../讲透AIfor各学科/天文/advanced/02-LSST时代前沿工程.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
