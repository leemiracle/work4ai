# 费曼检验（⚠️ 不适用）· 物理 · PINN 数学严格推导

> 自动生成 2026-08-04 19:49 | 原文 [`讲透AIfor各学科/物理/advanced/01-PINN数学严格推导.md`](../讲透AIfor各学科/物理/advanced/01-PINN数学严格推导.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
