...
| 境外资源 | 国内可访问对应 |
|---|---|
| RT-2 / π₀ / GR00T（HuggingFace）| ModelScope 搜机器人模型 / Gitee |
| NVIDIA Isaac Sim（仿真）| 国产：**腾讯 RobotStudio** / **字节机器人仿真** |
| MuJoCo / PyBullet（物理仿真）| Gitee 镜像 / 可直连（开源）|
| ROS 2（GitHub）| [Gitee ROS 镜像](https://gitee.com) / 清华镜像 |
