# 费曼检验（⚠️ 不适用）· 机器人 · Sim2Real 工程实践

> 自动生成 2026-08-04 19:49 | 原文 [`讲透AIfor各学科/机器人/advanced/02-Sim2Real工程.md`](../讲透AIfor各学科/机器人/advanced/02-Sim2Real工程.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
