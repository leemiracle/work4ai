...
| 境外资源 | 国内可访问对应 |
|---|---|
| GNoME（DeepMind 新材料用于农业）| Semantic Scholar 取论文 |
| 多光谱遥感数据（Landsat/Sentinel）| [中科院空天院](http://air.cas.cn) / [国家卫星气象中心](http://nsmc.cma.gov.cn) |
| FAO 联合国粮农数据 | 可直连（公开）/ [中国农科院](http://caas.cn) |
| PlantVillage 数据集（GitHub）| Gitee 镜像 / 阿里云天池 |
