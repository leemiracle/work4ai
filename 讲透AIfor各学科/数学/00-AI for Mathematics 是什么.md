...
| 境外资源 | 国内可访问对应 |
|---|---|
| Lean / Mathlib（GitHub）| [Gitee 搜 lean4](https://gitee.com) / [Lean 中文社区](https://lean-zh.github.io) |
| Coq / Isabelle | Gitee 镜像 / 清华 TUNA |
| AlphaProof（DeepMind）| Semantic Scholar 取论文 |
| arXiv math | 中科院镜像 / Semantic Scholar |
| Wolfram Mathematica（商业）| 国产替代：**SymPy**（开源）/ **Maxima**（开源）|
