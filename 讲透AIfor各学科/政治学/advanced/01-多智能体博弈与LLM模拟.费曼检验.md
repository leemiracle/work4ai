# 费曼检验（⚠️ 不适用）· 政治学 · 多智能体博弈与 LLM 模拟

> 自动生成 2026-08-04 19:49 | 原文 [`讲透AIfor各学科/政治学/advanced/01-多智能体博弈与LLM模拟.md`](../讲透AIfor各学科/政治学/advanced/01-多智能体博弈与LLM模拟.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
