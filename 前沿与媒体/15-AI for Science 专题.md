...
> 姊妹篇：[`../讲透模型/讲透基础模型/`](../讲透模型/讲透基础模型)（NTP 范式）｜[`13-学术圈`](./13-AI学术圈与PhD招聘专题.md)（科研生态）。
>
...
> 🔗 相关：[`../讲透模型/讲透基础模型/`](../讲透模型/讲透基础模型) ｜ [`../讲透模型/讲透生成模型/`](../讲透模型/讲透生成模型)（扩散模型 → AlphaFold 3）｜ [`13-学术圈`](./13-AI学术圈与PhD招聘专题.md) ｜ **世界模型×AI4Sci×AI4Math 调研卷**（1152 arXiv 一手核实）：[`top-20-insights`](../code-projects/世界模型与AI4Sci调研/docs/top-20-insights.md) ｜ [`ten-lessons`](../code-projects/世界模型与AI4Sci调研/docs/ten-lessons.md)，全卷选粹在 [`code-projects/世界模型与AI4Sci调研/`](../code-projects/世界模型与AI4Sci调研/README.md) ⭐ 2026-09-09
