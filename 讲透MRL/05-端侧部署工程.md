...
# 下载到仓库外的缓存目录 (★ 不进 git!)
export MODELSCOPE_CACHE=/data/usershare/ai/models
...
model_dir = snapshot_download('google/embeddinggemma-300m',
                              cache_dir='/data/usershare/ai/models')
...
model = SentenceTransformer(
    "/data/usershare/ai/models/embeddinggemma-300m",
...
modelscope download --model jinaai/jina-embeddings-v5-text-nano-text-matching-GGUF \
                    --local_dir /data/usershare/ai/models/jina-v5-nano-gguf
...
./build/bin/llama-embedding \
    -m /data/usershare/ai/models/jina-v5-nano-gguf/v5-nano-text-matching-Q5_K_M.gguf \
