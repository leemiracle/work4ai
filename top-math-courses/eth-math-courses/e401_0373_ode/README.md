# ETH Zürich 401-0373-00L — Ordinary Differential Equations
...
## 📍 在数学全景中的位置
本课属于 **微分方程** 主题。前置/后续课程见 [`../UNIFIED_ROADMAP.md`](../../UNIFIED_ROADMAP.md) 和 [`../DEEP_ANALYSIS.md`](../../DEEP_ANALYSIS.md)。

## 🔬 理论联系实际（ML / 工程）
扩散方程→DDPM/heat kernel→高斯卷积/PINN→物理神经网络
...
## 参考资源
- **教材**：Arnold ⚠️
- **课程主页**：建议搜索 "ETH Zürich 401-0373-00L"
