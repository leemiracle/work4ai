# ETH Zürich 401-0151-00L — Linear Algebra II

> **学校**：ETH Zürich | **线性代数 II**
> **编号**：401-0151-00L
...
## 📍 在数学全景中的位置
本课属于 **线性代数** 主题。前置/后续课程见 [`../UNIFIED_ROADMAP.md`](../../UNIFIED_ROADMAP.md) 和 [`../DEEP_ANALYSIS.md`](../../DEEP_ANALYSIS.md)。

## 🔬 理论联系实际（ML / 工程）
矩阵运算/SVD→PCA/特征值→协方差→高斯/LoRA低秩近似
...
## 参考资源
- **教材**：⚠️ 待核实
- **课程主页**：建议搜索 "ETH Zürich 401-0151-00L"
