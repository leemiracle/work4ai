# UC Berkeley Math 1B — Calculus (Continuation)

> **学校**：UC Berkeley | **微积分 II**
> **编号**：Math 1B
...
## 📍 在数学全景中的位置
本课属于 **微积分** 主题。前置/后续课程见 [`../UNIFIED_ROADMAP.md`](../../UNIFIED_ROADMAP.md) 和 [`../DEEP_ANALYSIS.md`](../../DEEP_ANALYSIS.md)。

## 🔬 理论联系实际（ML / 工程）
梯度∇f→SGD/链式法则→反向传播/积分→概率密度归一化
