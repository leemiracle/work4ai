# Stanford MATH 121 — Galois Theory

> **学校**：Stanford | **Galois 理论**
> **编号**：MATH 121
...
## 📍 在数学全景中的位置
本课属于 **代数/数论** 主题。前置/后续课程见 [`../UNIFIED_ROADMAP.md`](../../UNIFIED_ROADMAP.md) 和 [`../DEEP_ANALYSIS.md`](../../DEEP_ANALYSIS.md)。

## 🔬 理论联系实际（ML / 工程）
群表示→张量/对称性→CNN等变/数论→RSA密码
