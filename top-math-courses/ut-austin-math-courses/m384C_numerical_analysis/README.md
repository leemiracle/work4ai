# UT Austin M 384C — Numerical Analysis I
...
## 📍 在数学全景中的位置
本课属于 **数值分析** 主题。前置/后续课程见 [`../UNIFIED_ROADMAP.md`](../../UNIFIED_ROADMAP.md) 和 [`../DEEP_ANALYSIS.md`](../../DEEP_ANALYSIS.md)。

## 🔬 理论联系实际（ML / 工程）
条件数→训练稳定性/QR→最小二乘→线性回归/浮点→反向传播
