...
- 学数学**从公理出发**的思维：[`../讲透Lean4数学/`](../讲透数学/讲透Lean4数学) NNG 从 Peano 公理证 2+2=4
- "证明"的概念：[`../讲透实分析/`](../讲透数学/讲透分析/讲透实分析) ε-δ
...
- 实分析（[`../讲透实分析/`](../讲透数学/讲透分析/讲透实分析)）= 解决这个危机的产物
...
- 你学实分析（[`../讲透实分析/`](../讲透数学/讲透分析/讲透实分析)）的所有概念都来自这场革命
- ε-δ 不是"刁难"，是**让数学无可争议**
