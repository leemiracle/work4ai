# Cambridge Part IB — Metric and Topological Spaces

> **学校**：Cambridge | **度量与拓扑空间**
> **编号**：Part IB
> **一手来源**：建议核实 Cambridge 官网最新课程目录
...
## 📍 在数学全景中的位置
本课属于 **拓扑/几何** 主题。前置/后续课程见 [`../UNIFIED_ROADMAP.md`](../../UNIFIED_ROADMAP.md) 和 [`../DEEP_ANALYSIS.md`](../../DEEP_ANALYSIS.md)。

## 🔬 理论联系实际（ML / 工程）
Banach不动点→SGD收敛/紧致→极值/同伦→数据分析
