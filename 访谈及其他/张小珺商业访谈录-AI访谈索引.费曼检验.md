# 费曼检验（⚠️ 不适用）· 张小珺《商业访谈录》· AI 深度访谈索引（33 集精选）

> 自动生成 2026-08-04 19:49 | 原文 [`访谈及其他/张小珺商业访谈录-AI访谈索引.md`](../访谈及其他/张小珺商业访谈录-AI访谈索引.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
...
- 原文行数：约 206+ 行
- 抽到的 H1：张小珺《商业访谈录》· AI 深度访谈索引（33 集精选）
- H2 数量：7
- 黑名单术语出现：116 次（无需外行翻译，因为这不是教学）
- 数学公式：0 行内 / 0 块
