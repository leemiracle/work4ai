# 费曼检验（⚠️ 不适用）· 信息论地基：熵、交叉熵、KL 散度

> 自动生成 2026-08-04 19:49 | 原文 [`讲透基础模型/math/信息论地基-熵交叉熵KL.md`](../讲透基础模型/math/信息论地基-熵交叉熵KL.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
...
- 原文行数：约 257+ 行
- 抽到的 H1：信息论地基：熵、交叉熵、KL 散度
- H2 数量：10
- 黑名单术语出现：50 次（无需外行翻译，因为这不是教学）
- 数学公式：97 行内 / 12 块
