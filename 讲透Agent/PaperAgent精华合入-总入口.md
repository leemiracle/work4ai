...
- **判断**：Deep Research 是 2025-2026 Agent 落地最成功的形态之一（OpenAI/Gemini/Perplexity 均已产品化）——**✅ 已于 2026-08-17 立项 [`讲透DeepResearch/`](./讲透DeepResearch/README.md) 新系列**（8 章篇目宪法 + 素材锚点 + 与讲透RAG/Agent/多Agent 的去重边界），本条目转为该系列的论文锚点库。
