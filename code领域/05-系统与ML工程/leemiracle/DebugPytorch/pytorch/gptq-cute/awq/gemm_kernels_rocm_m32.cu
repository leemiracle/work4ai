...
template <int num_warps, int tileM, int tileN, int tileK,
          ...
          bool is_even_M = true>
__launch_bounds__(256) __global__ void gemm_forward_4bit_for_m32(
...
void awq_gemm_rocm_for_m32(half* __restrict__ A,                // [M, K]
  ...
  BOOL_SWITCH(is_even_m, is_even_M, [&] {
    ...
    vllm::awq::gemm_forward_4bit_for_m32<
        num_warps, 32, tileN, 32, SmemLayoutAtomA, GmemTiledCopyA,
