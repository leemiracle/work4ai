# 三角色资源档案：GTM186.Fourier.analysis.on.number__.fields.(GTM186)
...
- 主题：分析·调和/小波
- 配套：书籍索引（`../书籍索引/美国研究生数学/GTM186.Fourier.analysis.on.number__.fields.(GTM186`）.md)
- 配套：书籍深度分析（`../书籍深度分析/美国研究生数学/GTM186.Fourier.analysis.on.number__.fields.(GTM186`）.md)
