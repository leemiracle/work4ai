# 三角色资源档案：GTM207.Algebraic.Graph.Theory,.Godsil,.Royle（代数图论）
...
- 主题：代数·抽象
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM207.Algebraic.Graph.Theory,.Godsil,.Royle（代数图论）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM207.Algebraic.Graph.Theory,.Godsil,.Royle（代数图论）.md)
