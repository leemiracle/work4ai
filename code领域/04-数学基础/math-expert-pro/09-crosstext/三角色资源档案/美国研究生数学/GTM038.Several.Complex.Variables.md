# 三角色资源档案：GTM038.Several.Complex.Variables
...
- 主题：分析·复分析
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM038.Several.Complex.Variables.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM038.Several.Complex.Variables.md)
