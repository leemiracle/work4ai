# 三角色资源档案：GTM117.Algebraic.Groups.and.Class.Fields,.Jean-Pierre.Serre（代数群和类域）
...
- 主题：代数·抽象
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM117.Algebraic.Groups.and.Class.Fields,.Jean-Pierre.Serre（代数群和类域）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM117.Algebraic.Groups.and.Class.Fields,.Jean-Pierre.Serre（代数群和类域）.md)
