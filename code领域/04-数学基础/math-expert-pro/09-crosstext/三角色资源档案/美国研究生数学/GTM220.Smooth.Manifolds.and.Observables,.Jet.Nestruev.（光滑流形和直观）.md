# 三角色资源档案：GTM220.Smooth.Manifolds.and.Observables,.Jet.Nestruev.（光滑流形和直观）
...
- 主题：几何·拓扑
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM220.Smooth.Manifolds.and.Observables,.Jet.Nestruev.（光滑流形和直观）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM220.Smooth.Manifolds.and.Observables,.Jet.Nestruev.（光滑流形和直观）.md)
