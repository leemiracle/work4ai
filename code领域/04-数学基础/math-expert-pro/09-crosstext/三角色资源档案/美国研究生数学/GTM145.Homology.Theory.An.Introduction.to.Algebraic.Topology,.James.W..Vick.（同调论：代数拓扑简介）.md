# 三角色资源档案：GTM145.Homology.Theory.An.Introduction.to.Algebraic.Topology,.James.W..Vick.（同调论：代数拓扑简介）
...
- 主题：代数·抽象
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM145.Homology.Theory.An.Introduction.to.Algebraic.Topology,.James.W..Vick.（同调论：代数拓扑简介）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM145.Homology.Theory.An.Introduction.to.Algebraic.Topology,.James.W..Vick.（同调论：代数拓扑简介）.md)
