# 三角色资源档案：GTM125.Complex.Variables.an.introduction
...
- 主题：分析·复分析
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM125.Complex.Variables.an.introduction.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM125.Complex.Variables.an.introduction.md)
