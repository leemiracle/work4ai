# 三角色资源档案：GTM213.From.Holomorphic.Functions.to.Complex.Manifolds,.Fritzsche,.Grauert.（从正则函数到复流形）
...
- 主题：分析·复分析
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM213.From.Holomorphic.Functions.to.Complex.Manifolds,.Fritzsche,.Grauert.（从正则函数到复流形）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM213.From.Holomorphic.Functions.to.Complex.Manifolds,.Fritzsche,.Grauert.（从正则函数到复流形）.md)
