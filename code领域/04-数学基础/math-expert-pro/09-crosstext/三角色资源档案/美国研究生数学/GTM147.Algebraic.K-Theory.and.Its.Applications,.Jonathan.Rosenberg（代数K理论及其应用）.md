# 三角色资源档案：GTM147.Algebraic.K-Theory.and.Its.Applications,.Jonathan.Rosenberg（代数K理论及其应用）
...
- 主题：代数·抽象
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM147.Algebraic.K-Theory.and.Its.Applications,.Jonathan.Rosenberg（代数K理论及其应用）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM147.Algebraic.K-Theory.and.Its.Applications,.Jonathan.Rosenberg（代数K理论及其应用）.md)
