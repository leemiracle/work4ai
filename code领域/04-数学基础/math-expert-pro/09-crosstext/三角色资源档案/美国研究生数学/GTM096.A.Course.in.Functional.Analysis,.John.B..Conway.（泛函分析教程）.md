# 三角色资源档案：GTM096.A.Course.in.Functional.Analysis,.John.B..Conway.（泛函分析教程）
...
- 主题：分析·泛函
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM096.A.Course.in.Functional.Analysis,.John.B..Conway.（泛函分析教程）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM096.A.Course.in.Functional.Analysis,.John.B..Conway.（泛函分析教程）.md)
