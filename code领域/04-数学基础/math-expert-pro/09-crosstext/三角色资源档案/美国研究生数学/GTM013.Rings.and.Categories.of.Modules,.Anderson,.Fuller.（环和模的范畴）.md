# 三角色资源档案：GTM013.Rings.and.Categories.of.Modules,.Anderson,.Fuller.（环和模的范畴）
...
- 主题：逻辑/基础/集合/范畴
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM013.Rings.and.Categories.of.Modules,.Anderson,.Fuller.（环和模的范畴）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM013.Rings.and.Categories.of.Modules,.Anderson,.Fuller.（环和模的范畴）.md)
