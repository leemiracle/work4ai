# 三角色资源档案：GTM031.抽象代数讲义 2（中文版，Nathan Jacobson）
...
- 主题：代数·抽象
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM031.抽象代数讲义 2（中文版，Nathan Jacobson）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM031.抽象代数讲义 2（中文版，Nathan Jacobson）.md)
