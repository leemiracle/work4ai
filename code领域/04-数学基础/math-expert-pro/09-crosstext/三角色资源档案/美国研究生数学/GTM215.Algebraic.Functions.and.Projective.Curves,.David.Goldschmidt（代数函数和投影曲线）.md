# 三角色资源档案：GTM215.Algebraic.Functions.and.Projective.Curves,.David.Goldschmidt（代数函数和投影曲线）
...
- 主题：代数·抽象
- 配套：[书籍索引](../../书籍索引/美国研究生数学/GTM215.Algebraic.Functions.and.Projective.Curves,.David.Goldschmidt（代数函数和投影曲线）.md)
- 配套：[书籍深度分析](../../书籍深度分析/美国研究生数学/GTM215.Algebraic.Functions.and.Projective.Curves,.David.Goldschmidt（代数函数和投影曲线）.md)
