# 三角色资源档案：GTM019.A.Hilbert.Space.Problem.Book,.P..R..Halmos（希尔伯特问题集）
...
- 主题：分析·泛函
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM019.A.Hilbert.Space.Problem.Book,.P..R..Halmos（希尔伯特问题集）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM019.A.Hilbert.Space.Problem.Book,.P..R..Halmos（希尔伯特问题集）.md)
