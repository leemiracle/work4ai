# 三角色资源档案：GTM089.Introduction.to.Algebraic.and.Abelian.Functions,.Serge.Lang.（代数和交换函数引论）
...
- 主题：代数·抽象
- 配套：[书籍索引](../../书籍索引/美国研究生数学/GTM089.Introduction.to.Algebraic.and.Abelian.Functions,.Serge.Lang.（代数和交换函数引论）.md)
- 配套：[书籍深度分析](../../书籍深度分析/美国研究生数学/GTM089.Introduction.to.Algebraic.and.Abelian.Functions,.Serge.Lang.（代数和交换函数引论）.md)
