# 三角色资源档案：GTM185.Using.Algebraic.Geomety,.Cox,.Little,.O.Shea.（应用代数几何）
...
- 主题：代数·抽象
- 配套：[书籍索引](../../书籍索引/美国研究生数学/GTM185.Using.Algebraic.Geomety,.Cox,.Little,.O.Shea.（应用代数几何）.md)
- 配套：[书籍深度分析](../../书籍深度分析/美国研究生数学/GTM185.Using.Algebraic.Geomety,.Cox,.Little,.O.Shea.（应用代数几何）.md)
