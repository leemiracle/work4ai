# 三角色资源档案：GTM222.Lie.Groups,.Lie.Algebras,.and.Representations,.Brian.C..Hall.（李群、李代数和表示）
...
- 主题：代数·抽象
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM222.Lie.Groups,.Lie.Algebras,.and.Representations,.Brian.C..Hall.（李群、李代数和表示）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM222.Lie.Groups,.Lie.Algebras,.and.Representations,.Brian.C..Hall.（李群、李代数和表示）.md)
