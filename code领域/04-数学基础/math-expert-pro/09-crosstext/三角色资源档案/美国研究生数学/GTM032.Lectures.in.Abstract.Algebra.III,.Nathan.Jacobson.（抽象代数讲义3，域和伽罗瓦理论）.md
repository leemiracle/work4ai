# 三角色资源档案：GTM032.Lectures.in.Abstract.Algebra.III,.Nathan.Jacobson.（抽象代数讲义3，域和伽罗瓦理论）
...
- 主题：代数·抽象
- 配套：[书籍索引](../../书籍索引/美国研究生数学/GTM032.Lectures.in.Abstract.Algebra.III,.Nathan.Jacobson.（抽象代数讲义3，域和伽罗瓦理论）.md)
- 配套：[书籍深度分析](../../书籍深度分析/美国研究生数学/GTM032.Lectures.in.Abstract.Algebra.III,.Nathan.Jacobson.（抽象代数讲义3，域和伽罗瓦理论）.md)
