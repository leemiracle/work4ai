# 三角色资源档案：GTM258.Foundation.of.Optimization.(ISBN.0387344314)
...
- 主题：优化/变分/控制
- 配套：书籍索引（`../书籍索引/美国研究生数学/GTM258.Foundation.of.Optimization.(ISBN.0387344314`）.md)
- 配套：书籍深度分析（`../书籍深度分析/美国研究生数学/GTM258.Foundation.of.Optimization.(ISBN.0387344314`）.md)
