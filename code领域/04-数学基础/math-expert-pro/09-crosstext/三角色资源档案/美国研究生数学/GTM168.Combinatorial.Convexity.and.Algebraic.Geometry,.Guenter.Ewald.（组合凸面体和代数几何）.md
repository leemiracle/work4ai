# 三角色资源档案：GTM168.Combinatorial.Convexity.and.Algebraic.Geometry,.Guenter.Ewald.（组合凸面体和代数几何）
...
- 主题：代数·抽象
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM168.Combinatorial.Convexity.and.Algebraic.Geometry,.Guenter.Ewald.（组合凸面体和代数几何）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM168.Combinatorial.Convexity.and.Algebraic.Geometry,.Guenter.Ewald.（组合凸面体和代数几何）.md)
