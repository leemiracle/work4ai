# 三角色资源档案：GTM074.Multiplicative.Number.Theory,.Davenport,.Montgomery.（乘法数论）
...
- 主题：数论
- 配套：[书籍索引](../../书籍索引/美国研究生数学/GTM074.Multiplicative.Number.Theory,.Davenport,.Montgomery.（乘法数论）.md)
- 配套：[书籍深度分析](../../书籍深度分析/美国研究生数学/GTM074.Multiplicative.Number.Theory,.Davenport,.Montgomery.（乘法数论）.md)
