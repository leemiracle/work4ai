# 三角色资源档案：GTM214.Partial.Differential.Equations,.Juergen.Jost.（偏微分方程）
...
- 主题：动力系统/ODE/PDE
- 配套：[书籍索引](../../书籍索引/美国研究生数学/GTM214.Partial.Differential.Equations,.Juergen.Jost.（偏微分方程）.md)
- 配套：[书籍深度分析](../../书籍深度分析/美国研究生数学/GTM214.Partial.Differential.Equations,.Juergen.Jost.（偏微分方程）.md)
