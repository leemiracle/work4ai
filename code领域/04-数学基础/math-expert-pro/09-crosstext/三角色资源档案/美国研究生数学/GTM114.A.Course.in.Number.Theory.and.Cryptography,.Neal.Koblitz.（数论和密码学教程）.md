# 三角色资源档案：GTM114.A.Course.in.Number.Theory.and.Cryptography,.Neal.Koblitz.（数论和密码学教程）
...
- 主题：数论
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM114.A.Course.in.Number.Theory.and.Cryptography,.Neal.Koblitz.（数论和密码学教程）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM114.A.Course.in.Number.Theory.and.Cryptography,.Neal.Koblitz.（数论和密码学教程）.md)
