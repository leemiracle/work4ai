# 三角色资源档案：GTM190.Problems.in.Algebraic.Number.Theory,.Esmonde,.Murty.（代数数论中的问题）
...
- 主题：代数·抽象
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM190.Problems.in.Algebraic.Number.Theory,.Esmonde,.Murty.（代数数论中的问题）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM190.Problems.in.Algebraic.Number.Theory,.Esmonde,.Murty.（代数数论中的问题）.md)
