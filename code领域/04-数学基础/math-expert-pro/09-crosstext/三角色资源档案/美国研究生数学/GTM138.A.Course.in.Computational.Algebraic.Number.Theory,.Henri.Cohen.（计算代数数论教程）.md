# 三角色资源档案：GTM138.A.Course.in.Computational.Algebraic.Number.Theory,.Henri.Cohen.（计算代数数论教程）
...
- 主题：代数·抽象
- 配套：[书籍索引](../书籍索引/美国研究生数学/GTM138.A.Course.in.Computational.Algebraic.Number.Theory,.Henri.Cohen.（计算代数数论教程）.md)
- 配套：[书籍深度分析](../书籍深度分析/美国研究生数学/GTM138.A.Course.in.Computational.Algebraic.Number.Theory,.Henri.Cohen.（计算代数数论教程）.md)
