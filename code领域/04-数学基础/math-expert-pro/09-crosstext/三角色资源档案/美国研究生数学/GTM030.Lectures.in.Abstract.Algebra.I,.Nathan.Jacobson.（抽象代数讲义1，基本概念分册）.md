# 三角色资源档案：GTM030.Lectures.in.Abstract.Algebra.I,.Nathan.Jacobson.（抽象代数讲义1，基本概念分册）
...
- 主题：代数·抽象
- 配套：[书籍索引](../../书籍索引/美国研究生数学/GTM030.Lectures.in.Abstract.Algebra.I,.Nathan.Jacobson.（抽象代数讲义1，基本概念分册）.md)
- 配套：[书籍深度分析](../../书籍深度分析/美国研究生数学/GTM030.Lectures.in.Abstract.Algebra.I,.Nathan.Jacobson.（抽象代数讲义1，基本概念分册）.md)
