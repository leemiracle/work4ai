# 三角色资源档案：GTM256.A.Course.in.Commutative.Algebra,.Kemper,.Gregor,.(2010,.ISBN.978-3-642-03544-9)
...
- 主题：代数·抽象
- 配套：书籍索引（`../书籍索引/美国研究生数学/GTM256.A.Course.in.Commutative.Algebra,.Kemper,.Gregor,.(2010,.ISBN.978-3-642-03544-9`）.md)
- 配套：书籍深度分析（`../书籍深度分析/美国研究生数学/GTM256.A.Course.in.Commutative.Algebra,.Kemper,.Gregor,.(2010,.ISBN.978-3-642-03544-9`）.md)
