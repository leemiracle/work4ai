# 三角色资源档案：通俗数学名著译丛19-当代数学：为了人类心智的荣耀R

> 自动生成 · 丛书：通俗数学名著译丛 · 主题：**代数·抽象**
...
- 主题：代数·抽象
- 配套：[书籍索引](../书籍索引/通俗数学名著译丛/通俗数学名著译丛19-当代数学：为了人类心智的荣耀R.md)
- 配套：[书籍深度分析](../书籍深度分析/通俗数学名著译丛/通俗数学名著译丛19-当代数学：为了人类心智的荣耀R.md)
