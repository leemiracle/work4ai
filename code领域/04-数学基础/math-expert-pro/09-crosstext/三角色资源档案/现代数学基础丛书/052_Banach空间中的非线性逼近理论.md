# 三角色资源档案：052_Banach空间中的非线性逼近理论

> 自动生成 · 丛书：现代数学基础丛书 · 主题：**分析·泛函**
...
- 主题：分析·泛函
- 配套：[书籍索引](../书籍索引/现代数学基础丛书/052_Banach空间中的非线性逼近理论.md)
- 配套：[书籍深度分析](../书籍深度分析/现代数学基础丛书/052_Banach空间中的非线性逼近理论.md)
- 配套：[主题深度报告](../书籍索引/主题深度报告-分析·泛函.md)
