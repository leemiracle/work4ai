# 三角色资源档案：69-概率与计算：算法与数据分析中的随机化和概率技术原书第2版
...
- 主题：概率·统计
- 配套：[书籍索引](../书籍索引/华章数学丛书/69-概率与计算：算法与数据分析中的随机化和概率技术原书第2版.md)
- 配套：[书籍深度分析](../书籍深度分析/华章数学丛书/69-概率与计算：算法与数据分析中的随机化和概率技术原书第2版.md)
