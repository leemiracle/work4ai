# 三角色资源档案：48-金融衍生品建模：基于MATLAB、C++和EXCEL工具
...
- 主题：金融数学
- 配套：[书籍索引](../书籍索引/华章数学丛书/48-金融衍生品建模：基于MATLAB、C++和EXCEL工具.md)
- 配套：[书籍深度分析](../书籍深度分析/华章数学丛书/48-金融衍生品建模：基于MATLAB、C++和EXCEL工具.md)
- 配套：[主题深度报告](../书籍索引/主题深度报告-金融数学.md)
