...
> 在本项目（D3000 算子优化实验室）里，我们用 供应链分析师 的眼睛看的是 **"基于 D3000 的国产算子库/推理引擎"** 这个子集——
> 即：把 GEMM/Conv/Attention 优化到峰值、沉淀国产算子栈这件事，在 供应链分析师 视角下的战略含义。
...
- [`Expert_06_Standards_Policy/README.md`](../../体系结构实验/Expert_06_Standards_Policy/README.md) —— ISA 选择的政治经济学（国内信创视角，与本透镜国际供应链视角硬切）
- [`Expert_07_Business/README.md`](../../体系结构实验/Expert_07_Business/README.md) —— BOM/毛利率（本透镜修正其"7nm 假设"）
