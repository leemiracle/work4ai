...
| 境外资源 | 国内可访问对应 |
|---|---|
| DeepMind 核聚变控制（Nature）| Semantic Scholar 取论文 |
| Plasma Control 代码（GitHub）| Gitee 镜像 |
| ITER 国际聚变数据 | [中科院等离子所](http://ipp.cas.cn) / EAST 装置 |
| 智能电网数据 | [国家电网](http://sgcc.com.cn) / 南方电网 |
