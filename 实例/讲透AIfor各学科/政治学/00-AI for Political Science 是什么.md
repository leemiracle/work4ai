...
| 境外资源 | 国内可访问对应 |
|---|---|
| SmallVille / Generative Agents（GitHub）| Gitee 镜像 |
| V-Dem 选举数据（瑞典）| [中科院政治学所](http://ips.cass.cn) / Semantic Scholar |
| Pew Research 数据 | 论文 / 中科院社会调查 |
| LLM 政治模拟框架 | ModelScope / Gitee |
