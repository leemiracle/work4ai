...
| 境外资源 | 国内可访问对应 |
|---|---|
| SWE-bench（GitHub）| Gitee 搜 SWE-bench |
| Devin / Cursor（境外 AI 编程）| [通义灵码](https://tongyi.aliyun.com) / [CodeGeeX 智谱](https://codegeex.cn) / [百度 Comate](https://comate.baidu.com) |
| GitHub Copilot | 通义灵码 / 腾讯云 AI 代码助手 |
| Stack Overflow | [掘金](https://juejin.cn) / [CSDN](https://csdn.net) / SegmentFault |
