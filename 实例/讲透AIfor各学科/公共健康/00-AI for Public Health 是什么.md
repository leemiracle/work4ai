...
| 境外资源 | 国内可访问对应 |
|---|---|
| Johns Hopkins COVID 数据（已停）| [国家卫健委](http://nhc.gov.cn) / [中国 CDC](http://chinacdc.cn) |
| Nextstrain（基因组流行病学，GitHub）| Gitee 镜像 / [中国 CDC 病毒所](http://chinacdc.cn) |
| mRNA 序列设计文献 | Semantic Scholar / 中科院文献 |
| WHO 数据 | 可直连（公开）/ 国家卫健委 |
