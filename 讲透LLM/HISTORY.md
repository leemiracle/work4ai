...
**DeepSeek 的思想史意义**：它打破了"只有硅谷大厂能做顶级 LLM"的叙事，也打破了"开源必然落后闭源"的假设。详见 [`讲透AI历史/advanced/06`](../讲透AI历史/advanced/06-中国AI发展独立史.md)。
...
- **中国 AI 史** → [`讲透AI历史/advanced/06`](../讲透AI历史/advanced/06-中国AI发展独立史.md)
