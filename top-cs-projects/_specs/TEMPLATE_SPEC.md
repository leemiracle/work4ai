...
| 文件 | 用途 |
|------|------|
| `/data/usershare/ai/work4ai/stanford-cs-projects/README.md` | 整体文档风格、章节结构、学习路径、论文清单 |
| `/data/usershare/ai/work4ai/stanford-cs-projects/topic1-choice/choice_theory.py` | 单文件代码风格（280 行，含 docstring/数学/可视化/main demo） |
| `/data/usershare/ai/work4ai/stanford-cs-projects/topic4-mlsys/kv_cache_sim.py` | 第二个代码样板（系统类，ASCII 可视化） |
| `/data/usershare/ai/work4ai/stanford-cs-projects/topic2-agent-v2/dspy_framework.py` | 第三样板（含 mock LLM 调用风格） |
| `/data/usershare/ai/work4ai/stanford-cs-projects/supplementary/all_micro_projects.py` | 微项目样板（一文件覆盖多门课） |
| `/data/usershare/ai/work4ai/stanford-cs-projects/core/llm.py` + `core/rag.py` + `core/eval.py` | 共享基础设施样板 |
...
**省时策略**：可以 `cp -r /data/usershare/ai/work4ai/stanford-cs-projects/core/ <uni>-cs-projects/core/`，然后批量替换头部注释和 docstring 里的"Stanford" → "<uni>"。
