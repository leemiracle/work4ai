...
| 枢纽 | [00-讲透笔记-算法经验枢纽.md](00-讲透笔记-算法经验枢纽.md) | 跨单元算法经验索引 | — | — |
...
1. **讲透生成模型 防的是什么欺骗？** → Deepfake / 合成内容冒充真实数据。
2. **被什么攻破？** → 生成质量过高致人眼无法分辨 / 水印被擦除。
3. **沉淀进哪条主链？** → AI 安全主链——水印 / 内容溯源 / 检测器。

### 一句话

> 生成模型越强，真实与生成的识别越难；水印与溯源是反生成欺骗的工程回应。

## 🔗 与其他宇宙的连接

- **[`讲透视频/`](../讲透视频/)**：视频生成=生成模型五族的时序巅峰（Sora=DiT 的视频化）
