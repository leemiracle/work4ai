...
### 🛤 想做 RL 理论研究
→ 00 + [`讲透统计学习理论`](../../讲透数学/讲透统计学习理论) → **[08 §4 Bellman/TD/Q-Learning 收敛性 + deadly triad](./08-Actor-Critic-SAC-ModelBased-OfflineRL.md#§4-收敛性证明cs234-的硬通货)（CS234 硬通货）** → **05**（pass@k 反转的数学根因）→ [07](./07-2026最新研究全景.md) §2 主题 ⑨
