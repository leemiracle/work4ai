...
> 🎯 **这是 2024-2026 最热的争论**——详见 [A02](./02-视频生成是世界模型吗.md)。
...
> 5. **博士级核心**：JEPA vs 像素生成是**方法论分歧**——抽象预测 vs 具体重建，**没有定论，看 [A02](./02-视频生成是世界模型吗.md) 的另一面**。
...
2. **深读 I-JEPA + VICReg 原文**：按 [A00 论文清单](./00-论文清单.md) 的 L3 标准。
3. **进入 [A02 视频生成是世界模型吗](./02-视频生成是世界模型吗.md)**：另一派的论据。
