...
>
> 🌐 **姊妹篇（2026-08-19）**：[`讲透Agent/Agent框架案例/MCP协议生态全景/`](../../讲透Agent/Agent框架案例/MCP协议生态全景/README.md)——生态统计（topics/mcp 64,438 仓六赛道）+ **2026-07-28 规范无状态化重构**（本手册基于 2025 规范：initialize 握手/Sampling/Roots 已在新版被删除或弃用，冲突处以该篇为准；三能力模型与实操代码不受影响）+ SDK v2/Registry/FastMCP 独立版格局。
