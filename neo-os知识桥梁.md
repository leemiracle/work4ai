...
work4ai 的费曼门要求每个讲透文件配套 `.费曼检验.md`（F1 外行复述 / F2 卡壳自曝 / F3 术语黑名单 / F4 回炉记录）。回流文件已用 [`费曼学习法/feynman-batch.py`](./费曼学习法/feynman-batch.py) 自动生成骨架：

| 回流文件 | 费曼检验骨架 | F1/F3（自动）| F2/F4（作者必填）|
|---------|------------|-------------|----------------|
| 讲透RL/04 | [`.费曼检验.md`](./讲透RL/04-RL与形式证明.费曼检验.md) | ✅ | 🔴 待作者 |
| 讲透RL/05 | [`.费曼检验.md`](./讲透RL/05-RLVR的极限.费曼检验.md) | ✅ | 🔴 待作者 |
| 讲透RL/06 | [`.费曼检验.md`](./讲透RL/06-RL与系统软件.费曼检验.md) | ✅ | 🔴 待作者 |
