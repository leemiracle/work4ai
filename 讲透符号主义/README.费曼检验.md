# 费曼检验（⚠️ 不适用）· 讲透符号主义（Symbolicism / GOFAI / Neurosymbolic）

> 自动生成 2026-08-04 19:49 | 原文 [`讲透符号主义/README.md`](../讲透符号主义/README.md)
> 类型：⚪ 不适用（索引/编年/清单/访谈）
...
- 原文行数：约 199+ 行
- 抽到的 H1：讲透符号主义（Symbolicism / GOFAI / Neurosymbolic）
- H2 数量：3
