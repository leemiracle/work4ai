...
| DeepSeek-Prover-V2（arXiv:2504.21801，2025-04-30）| 开源 7B/671B Lean4 prover：MiniF2F 88.9% SOTA；**本地已部署实战** → [讲透Agent/实战案例-Prover数学Agent](../../讲透Agent/实战案例-Prover数学Agent/README.md)（十条规律逆向蒸馏 + harness/skill/prompt 三件套，2×内网GPU 实测） |
