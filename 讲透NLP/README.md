...
| 01 | `01-导论-NLP全景.md` | NLP 解决什么问题？任务分类 | — |
...
| 03 | `03-N元语法语言模型.md` | 不用神经网络怎么做语言模型？为什么要平滑 | — |
| 04 | `04-逻辑回归与文本分类.md` | 最简单的神经分类器长啥样？sigmoid 为何神奇 | — |
| 05 | `05-词嵌入-word2vec与GloVe.md` | 词怎么变成向量？为什么"国王−男人+女人≈女王" | — |
| 06 | `06-神经网络基础.md` | 反向传播与梯度下降（导引到《讲透基础模型》） | — |
| 07 | `07-大语言模型.md` | GPT 类模型如何工作（导引） | — |
| 08 | `08-Transformer.md` | attention 为何革命性（导引到《讲透Transformer》） | — |
...
| 11 | `11-信息检索与RAG.md` | 检索增强生成的工作原理（导引到《讲透RAG》） | — |
| 12 | `12-机器翻译.md` | 从 IBM Model 到 Transformer MT，再到 LLM 翻译 | Model1 EM 无监督学出 the→那个(t=0.696)；打乱词序后 t 表【完全相同】(差 6.66e-16)→证其对词序盲目 |
| 13 | `13-RNN与LSTM.md` | attention 之前如何处理变长序列？梯度消失怎么治 | — |
| 14 | `14-语音学与特征提取.md` | 音素/MFCC/语谱图——语音的"token" | — |
| 15 | `15-自动语音识别-ASR.md` | HMM→CTC→Attention→Whisper 的演化 | — |
| 16 | `16-语音合成-TTS.md` | 从拼接合成到 Neural TTS 到 zero-shot 声音克隆 | — |

### Volume II: Annotating Linguistic Structure（9 章）

| # | 文件 | 核心问题 | 实验关键数字 |
|---|---|---|---|
| 17 | `17-序列标注-POS与NER.md` | 给词打标签：HMM/CRF/BiLSTM-CRF/BERT 系 | — |
...
| 19 | `19-依存句法分析.md` | 为什么中文更适合依存？transition-based vs graph-based | — |
